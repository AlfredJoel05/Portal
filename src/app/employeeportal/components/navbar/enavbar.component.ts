...
import { ROUTES } from '../sidebar/esidebar.component';
import {Location, LocationStrategy, PathLocationStrategy} from '@angular/common';
import { Router } from '@angular/router';
import Chart from 'chart.js';
import { EmployeeNavService } from './enav.service';
import { EmployeeDashboardService } from '../../dashboard/edashboard.service';
...
export class EmployeeNavbarComponent implements OnInit {
    ...
    constructor(location: Location,  private element: ElementRef, private router: Router, private navService : EmployeeNavService, private dashboardService : EmployeeDashboardService) {
