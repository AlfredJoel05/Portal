...
import { ROUTES } from '../sidebar/vsidebar.component';
import {Location, LocationStrategy, PathLocationStrategy} from '@angular/common';
import { Router } from '@angular/router';
import Chart from 'chart.js';
import { VendorNavService } from './vnav.service';
import { VednorDashboardService } from '../../dashboard/vdashboard.service';
...
export class VendorNavbarComponent implements OnInit {
    ...
    constructor(location: Location,  private element: ElementRef, private router: Router, private navService : VendorNavService, private dashboardService : VednorDashboardService) {
